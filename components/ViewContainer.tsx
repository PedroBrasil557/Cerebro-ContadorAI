...
interface ViewContainerProps {
  ...
  cdiRate: number
  marketRates?: { usd: number, btc: number, cdi: number } // Novo Prop
...
export default function ViewContainer(props: ViewContainerProps) {
  ...
  return (
    <div className="h-full w-full animate-in fade-in duration-300">
      ...
      {/* Investimentos agora com dados reais de Mercado */}
      ...
      {activeTab === 'perfil' && (
        <ProfileView user={props.user} onUpdateProfile={props.onUpdateProfile} />
      )}
