    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
        <motion.div
          ...
          className="absolute inset-0 cursor-pointer bg-[rgba(2,6,23,0.72)] backdrop-blur-md"
        />
        ...
        <motion.div
          ...
          className="relative w-full max-w-[440px] overflow-hidden rounded-[2.25rem] border border-[var(--color-card-border)] bg-[var(--color-bg-elevated)] shadow-[var(--shadow-elevated)]"
        >
          <div className="pointer-events-none absolute left-1/2 top-0 h-40 w-full -translate-x-1/2 bg-[radial-gradient(ellipse_at_top,rgba(99,102,241,0.18),transparent_70%)]" />
          ...
          {!isRedirecting && (
            <button
              ...
              aria-label="Fechar"
              onClick={onClose}
              className="absolute right-6 top-6 z-20 rounded-full border border-[var(--color-card-border)] bg-[var(--color-bg-surface)] p-2.5 text-[var(--color-text-helper)] transition-all hover:border-[var(--color-card-accent-border)] hover:text-[var(--color-text-primary)]"
            >
              <X size={18} />
            </button>
          )}
          ...
          <div className="relative z-10 flex flex-col items-center p-10 text-center">
            ...
            <h2 id="upgrade-title" className="mb-3 text-3xl font-black tracking-tighter text-[var(--color-text-primary)]">
            ...
            <div className="mb-10 grid w-full grid-cols-1 gap-3 text-left">
              {[
                ...
                <div key={i} className="flex items-center gap-4 rounded-2xl border border-[var(--color-card-border)] bg-[var(--color-bg-surface)] p-4">
            ...
            <button
              ...
              className="group relative flex w-full items-center justify-center gap-3 overflow-hidden rounded-[1.5rem] bg-[var(--color-action-primary)] py-5 text-[10px] font-black uppercase tracking-[0.3em] text-white shadow-[0_16px_36px_rgba(124,58,237,0.22)] transition-all hover:scale-[1.01] hover:bg-[var(--color-action-primary-hover)] active:scale-[0.99] disabled:cursor-wait disabled:bg-[var(--color-action-disabled-fill)] disabled:text-[var(--color-text-disabled)]"
            >
              {isRedirecting ? (
